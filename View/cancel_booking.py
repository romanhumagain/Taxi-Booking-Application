...
class CancelBooking:
    ...
    def show_cancel_booking_window(self):
        ...
        self.cancel_frame = Frame(self.cancel_booking_window, bg="#2c2c2c", height=260)
        ...
        self.bookingid_entry = customtkinter.CTkEntry(master=self.cancel_frame, font=(self.font, 16, 'bold'),
                                                      width=80, placeholder_text="Booking ID", height=40,
        ...
        self.date_entry = customtkinter.CTkEntry(master=self.cancel_frame, font=(self.font, 16),
                                                 width=120, placeholder_text="Drop Up Date", height=40,
        ...
        self.time_entry = customtkinter.CTkEntry(master=self.cancel_frame, font=(self.font, 16),
                                                 width=120, placeholder_text="Drop Up Time", height=40,
        ...
        self.table_frame = Frame(self.cancel_booking_window, bg="#2c2c2c", height=260)
        ...
        #
        self.booking_records_table = tkinter.ttk.Treeview(self.table_frame, height=11, columns=("bookingid", "pickupaddress", "pickupdate", "pickuptime","pickoffaddress"), show="headings")
