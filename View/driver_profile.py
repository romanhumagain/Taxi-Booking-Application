...
class DriverProfile:
    ...
    def show_driver_profile(self):
        ...
        self.update_button = customtkinter.CTkButton(master=self.profile_frame, image=update_btn_image,
                                                     ...
                                                     corner_radius=15, height=34, width=100, command=self.show_update_profile_window)
        ...
        self.change_password_button = customtkinter.CTkButton(master=self.profile_frame, image=password_btn_image,
                                                              ...
                                                              corner_radius=15, height=34, width=100,command=self.show_change_password_window)
        ...
        if password == confirm_password:
            if len(password) >= 8:
                ...
                if password_changed:
                    ...
                    messagebox.showerror("Password Changed Failed", "Sorry, could't change your password !",parent=self.change_password_window)
            else:
...
#     ================= WINDOW FOR UPDATING PROFILE ========================
    def show_update_profile_window(self):
        ...
        self.license_entry = customtkinter.CTkEntry(master=self.update_profile_window, width=170, height=38,placeholder_text="License Number",font=(self.font, 15))
        ...
        self.exit_button = customtkinter.CTkButton(master=self.update_profile_window, text="Exit", font=(self.font, 16),height=35,corner_radius=10, command=self.cancel_update_window)
